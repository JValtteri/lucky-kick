...
def menu(screen, clock, config):
    ...
    credit_button = game_objects.Texts(config.RUBIK_FONT, "(c) 2020 JValtteri", size=20, color=(205,205,205), xy=(30, config.SCREEN_SIZE[1] - 30 ))
    ...
    while in_menu:
        ...
        if start_button.rect.collidepoint((mouse_x, mouse_y)):
            highlite.pos(start_button.rect.midbottom[0], start_button.rect.midbottom[1])
    ...
    return track_number, hole_number

def track_menu(screen, clock, config, exit_button, credit_button, highlite):
    font_size = 40
    button1 = game_objects.Texts(config.SC_FONT, "1", size=font_size, xy=(config.SCREEN_SIZE[0]/2-70, 70), tag=1)
    button2 = game_objects.Texts(config.SC_FONT, "2", size=font_size, xy=(config.SCREEN_SIZE[0]/2+70, 70), tag=2)
    button3 = game_objects.Texts(config.SC_FONT, "3", size=font_size, xy=(config.SCREEN_SIZE[0]/2-70, 70+44), tag=3)
    button4 = game_objects.Texts(config.SC_FONT, "4", size=font_size, xy=(config.SCREEN_SIZE[0]/2+70, 70+44), tag=4)
    button5 = game_objects.Texts(config.SC_FONT, "5", size=font_size, xy=(config.SCREEN_SIZE[0]/2-70, 70+88), tag=5)
    button6 = game_objects.Texts(config.SC_FONT, "6", size=font_size, xy=(config.SCREEN_SIZE[0]/2+70, 70+88), tag=6)
    button7 = game_objects.Texts(config.SC_FONT, "7", size=font_size, xy=(config.SCREEN_SIZE[0]/2-70, 70+132), tag=7)
    button8 = game_objects.Texts(config.SC_FONT, "8", size=font_size, xy=(config.SCREEN_SIZE[0]/2+70, 70+132), tag=8)
    button9 = game_objects.Texts(config.SC_FONT, "9", size=font_size, xy=(config.SCREEN_SIZE[0]/2-70, 70+176), tag=9)
    button10 = game_objects.Texts(config.SC_FONT, "10", size=font_size, xy=(config.SCREEN_SIZE[0]/2+70, 70+176), tag=10)
